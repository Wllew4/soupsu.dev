...
function changeClip (i) {
    ...
    document.getElementById("clipplayer").setAttribute("src", "https://clips.twitch.tv/embed?parent=name.com&parent=soupsu.live&parent=boiling-reef-80938.herokuapp.com&autoplay=false&muted=false&clip=" + clip[current]);
}
